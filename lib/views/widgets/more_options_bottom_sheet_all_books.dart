...
import 'package:bookhive/utils/constants.dart';
import 'package:bookhive/views/books_detail_view.dart';
import 'package:bookhive/views/remove_book_view.dart';
import 'package:bookhive/views/widgets/edit_book_bottom_sheet.dart';
                            ...
                            Obx(() {
                              return Expanded(
                                ...
                                child: ElevatedButton(
                                  ...
                                  onPressed: () {
                                    bookController.deleteBook(widget.id);
